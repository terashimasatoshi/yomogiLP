    ...
    <>
      ...
      <section id="menu" className="py-24 bg-white">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          >
            <div className="absolute -right-10 -top-10 w-40 h-40 bg-brand-primary/10 rounded-full animate-pulse"></div>
      ...
      <section className="py-24 bg-brand-bgDark relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full opacity-30 pointer-events-none">
           <div className="absolute top-20 left-10 w-32 h-32 bg-brand-primary/20 rounded-full blur-2xl"></div>
           <div className="absolute bottom-20 right-10 w-40 h-40 bg-brand-secondary/20 rounded-full blur-2xl"></div>
        </div>
            ...
            {FLOW_STEPS.map((step, index) => (
              ...
              >
                {index !== FLOW_STEPS.length - 1 && (
                  <div className="absolute left-1/2 md:left-[5.5rem] bottom-[-2rem] w-1 h-8 bg-brand-primary/20 -z-10 hidden md:block"></div>
                )}
                
                <div className="flex-shrink-0 w-20 h-20 bg-brand-highlight rounded-full flex items-center justify-center border-4 border-white shadow-sm text-brand-primary font-bold text-xl relative z-10 group-hover:scale-110 transition-transform">
                   0{step.step}
                </div>
                ...
                <div className="flex-grow text-center md:text-left">
                  <div className="flex flex-col md:flex-row md:items-center gap-4 mb-4 justify-center md:justify-start">
                    ...
                    <span className="inline-block bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-sm">{step.time}</span>
                  </div>
